...
<body>
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "INSERT INTO tintuc VALUES ('',:tieude, :ndngan, :noidung, :file__name__, :ngay, :tacgia)";
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<table>
			...
			<tr>
				<td>Tiêu đề</td>
				<td><input type="text" name="tieude" size="50" /></td>
			</tr>
			<tr>
				<td>Nội dung ngắn</td>
				<td><textarea name="ndngan"></textarea></td>
			</tr>
			<tr>
				<td>Nội dung chi tiết</td>
				<td><textarea name="noidung" id="chitiet"></textarea></td>
			</tr>
			<tr>
				<td>Hình ảnh</td>
