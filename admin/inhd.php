                        ...
                        <tr>
                          <td>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tbody>
                                <tr>
                                  <td colspan="2"><strong>CỬA HÀNG ĐIỆN THOẠI LỘC LÊ</strong></td>
                                </tr>
                                <tr>
                                  <td>Địa chỉ</td>
                                  <td>: 180 Cao Lỗ, Quận 8, TP Hồ Chí Minh</td>
                                </tr>
                                <tr>
                                  <td width="65">Tel:</td>
                                  <td>: 0424 666888</td>
                                ...
                                <tr>
                                  <td>Email</td>
                                  <td>:dh52001727@student.stu.edu.vn</td>
                                </tr>
                              </tbody>
                            </table>
                          </td>
        ...
        <td height="54">
          ...
          <table width="100%">
            ...
            <tr>
              ...
              $rows2 = $dbh->prepare($sql2);
              $rows2->bindParam(":mahd", $mahd);
              $rows2->execute();
              $row2 = $rows2->fetch(PDO::FETCH_ASSOC);

              ?>
              <td>
                <?php if ($row2['phuongthucthanhtoan'] == 1)
                  echo "Qua bưu điện";
                else if ($row2['phuongthucthanhtoan'] == 2)
                  echo "Qua thẻ ATM";
                else
          ...
          <table width="100%" style="border-collapse:collapse;">
            <tr>
              ...
              <td width="25%" align="right" bgcolor="#CCCCCC" align="left" style="border:1px solid green;">
            ...
            while ($row = $rows->fetch(PDO::FETCH_ASSOC)) {
              ...
              <tr>
                ...
                <td align="center" align="left" style="border:1px solid green;">
            ...
            <tr style="border:1px solid green;">
              <td colspan="4" align="left">
                <div align="right">Tổng giá trị đơn hàng:</div>
              </td>
              <td align="right"><b>
