	...
	<div id="admincon">
		...
		<div id="sanphammoi">
			<table>
				...
				<?php
				$i = 1;
				$sql = $dbh->prepare("select * from hoadon where trangthai='1'");
				$sql->execute();
				...
				<?php } ?>
				<tr>
					<td colspan=6 align="right" style="padding-right:20px; height:30px;"><a
							href="admin.php?admin=hienthihd">Chi tiết</a></td>
				</tr>
			</table>
		</div>
	</div>
