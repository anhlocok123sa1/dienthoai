	...
	<form action="index.php?content=cart&action=insert" method="POST" id="a" onsubmit="return kiemtra();">
		<table>
			...
			if (isset($_SESSION['idnd'])) {
				...
				$query->bindParam(':idnd', $_SESSION['idnd']);
				$query->execute();
			...
			?>
			<tr>
				<td colspan="2" align="center" style="">Thông tin khách hàng</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="dienthoai" value="0<?php echo $row['dienthoai'] ?>" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center" style="">Phương thức thanh toán</td>
			</tr>
			<tr>
