<form action="update_dangky.php" method="post" name="frm" onsubmit="return dangky()">
	<div class="dangky">
		...
		<table>
			<tr>
				<td>Tên đăng nhập <font color="red">*</font>
				</td>
				<td class="input"> <input type="text" name="user" size="40"></td>
			</tr>
			<tr>
				<td>Tên người dùng <font color="red">*</font>
				</td>
				<td class="input"><input type="text" name="tennd" size="40"></td>
			</tr>
			<tr>
				<td>Mật khẩu <font color="red">*</font>
				</td>
				<td class="input"><input type="password" name="pass" size="40"></td>
			</tr>
			<tr>
				<td>Nhập lại mật khẩu <font color="red">*</font>
				</td>
				<td class="input"><input type="password" name="pass1" size="40"></td>
			</tr>
			<tr>
				<td>Ngày sinh </td>
				<td class="input"><input type="date" name="ngaysinh"></td>
			</tr>
			<tr>
				<td>Giới tính </td>
				<td class="input">
			...
			<tr>
				<td>Điện thoại <font color="red">*</font>
				</td>
