<form action="insert_hotro.php" method="post" name="frm" onsubmit="return kiemtra()">
	<div id="hotro">
		...
		<table>
			<tr>
				<td>Chủ đề: <font color="red">*</font>
				</td>
				<td class="input"><input type="text" name="chude" size="40"></td>
			</tr>
			<tr>
				<td>Họ tên: <font color="red">*</font>
				</td>
				<td class="input"><input type="text" name="hoten" size="40"></td>
			</tr>
			<tr>
			...
			<tr>
				<td>Nội dung <font color="red">*</font>
				</td>
				<td class="input"><textarea name="noidung"></textarea></td>
			</tr>
			<tr>
